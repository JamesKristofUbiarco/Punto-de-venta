...
int main(int argc, char** argv) {
	string codigo[13] {
        "7501055317875","7501030462859","016000506435","019836103021","744886239283","7501055302086","7501198350432","7501011147942","75067656","7501086801046","75051938","724869003520","7501761865530"
    };
	string descripcion[13] {
        "Fuze Tea Durazno","galletas principe","lucky charms treats","Boing de Guayaba","Agua natural skarch","Coca Cola","canada dry","Inspireka","Trident Azules","Agua Epura","Bubbaloo de fresa","gomitas de llave","Stila fit"
    };
	string cantidad[13] {
        "600 ml","105 gr","24 gr","500 ml","1 l","500 ml","600 ml","45 gr","6.5 gr","1 l","5.5 gr","6 gr","23 gr"
    };
	float precio[13] {
        15,15,9,10,10,15,20,18,3,8,3,2,5
    };
    int inventario[13] {
    ...
    do {
        ...
        if(codigoBarras == "0") {
            for( indice = 0 ; indice <= indice2 - 1; indice++) {
                cout << endl << articulosLlevadosCodigo[indice] << "\t" << articulosLlevadosDescripcion[indice] << "\t $" << articulosLlevadosPrecio[indice];
            }
    ...
    for(indice = 0; indice <= 12; indice++) {
        cout << endl << codigo[indice] << "\t" << descripcion[indice] << "\t\t" << cantidad[indice] << "\tvendidos: " << totalArticulos[indice];       //Aqu� se escribe el flujo de caja diario
    }
